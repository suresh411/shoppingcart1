...
export class ServiceService {
  ...
  constructor() { }
  products=[
         {id:1,name:"MI Note8 Pro",price:'15,000',image:this.img1},
         {id:2,name:"Oppo F11 Pro",price:'15,990',image:this.img2},
         {id:3,name:"Realme-3i",price:'10,000',image:this.img3},
         {id:4,name:"Redmik20",price:'20,000',image:this.img4},
